...
public class DateHG
{
    ...
    private string[] allFormats = { "MM/dd/yyyy", "yyyy/MM/dd", "yyyy/M/d", "dd/MM/yyyy", "d/M/yyyy", "dd/M/yyyy", "d/MM/yyyy", "yyyy-MM-dd", "yyyy-M-d", "dd-MM-yyyy", "d-M-yyyy", "dd-M-yyyy", "d-MM-yyyy", "yyyy MM dd", "yyyy M d", "dd MM yyyy", "d M yyyy", "dd M yyyy", "d MM yyyy", "yyyy/MM/dd hh:mm:ss tt", "M/d/yyyy hh:mm:ss tt", "yyyy/MM/dd hh:mm:ss", "M/d/yyyy hh:mm:ss", "yyyy-MM-dd hh:mm:ss.fff" };
    public CultureInfo arCul;
    public CultureInfo enCul;
    ...
    public string HijriToGreg(string hijri)
    {
        ...
        try
        {
            DateTime tempDate = DateTime.ParseExact(hijri, "dd/MM/yyyy", arCul.DateTimeFormat, DateTimeStyles.AllowWhiteSpaces);
