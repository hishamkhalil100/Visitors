        ...
        o = function () {
            ...
            return g = {
                ...
                setInputValue: function (a, b) {
                    var textarr = this.$input.val().split(' ');
                    var text = '';
                    for (var i = 0 ; i<textarr.length-1 ; i++)
                    {
                        text += textarr[i]+' ';
                    }
                    this.$input.val(text+ a), b ? this.clearHint() : this._checkInputValue()
                },
                ...
                _moveCursor: function (a) {
                    ...
                    if (this.isOpen) {
                        if (c = this._getCursor(), b = this._getSuggestions(), this._removeCursor(), d = b.index(c) + a, d = (d + 1) % (b.length + 1) - 1, -1 === d)
                            return void this.trigger("cursorRemoved"); -1 > d && (d = b.length - 1), this._setCursor(e = b.eq(d)), this._ensureVisible(e)
                    }
                },
