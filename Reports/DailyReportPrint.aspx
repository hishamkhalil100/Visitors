<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailyReportPrint.aspx.cs" Inherits="Reports.Reports_DailyReportPrint" %>
...
<body style="direction: rtl; background: #fff" onload="window.print()" onfocus="window.close()">
    <div style="margin: 0 auto;">
        ...
        <h4 id="h4date" style="text-align: center;">احصائية يومية بعدد الزوار في  تاريخ
