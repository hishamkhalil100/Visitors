<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VistorsWeeklyReport.aspx.cs" Inherits="Reports.Reports_VistorsWeeklyReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function printdiv(printpage) {
            ...
            window.open("/visitors/Reports/WeeklyReportPrint.aspx?date=" + datestart);
        ...
        <section id="content" class="table-layout animated fadeIn">
            ...
            <div class="tray tray-center">
                ...
                <div class="content-header">
                    <h2>إحصائية <b>إسبوعية </b>بعدد الزوار</h2>
                </div>
