<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VistorsMonthlyReport.aspx.cs" Inherits="Reports.Reports_VistorsMonthlyReport" %>
   ...
   <!-- OR for ThemeRoller styling
    ...
    <script>
        ...
        function printdiv(printpage) {
            ...
            window.open("/visitors/Reports/MonthlyReportPrint.aspx?date=" + datestart);
        ...
        <section id="content" class="table-layout animated fadeIn">
            ...
            <div class="tray tray-center">
                ...
                <div class="content-header">
                    <h2>إحصائية <b>شهرية </b>بعدد الزوار</h2>
                </div>
