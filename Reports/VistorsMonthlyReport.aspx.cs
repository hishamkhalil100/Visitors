...
namespace Reports
{
    public partial class Reports_VistorsMonthlyReport : System.Web.UI.Page
    {
        // dicalare footer var for calculate summation
        int _totalPer1 = 0; int _totalPer2 = 0; int _totalPer3 = 0; int _totalPer4 = 0;
        int _totalPer5 = 0; int _totalPer6 = 0; int _totalPer7 = 0; int _totalPer8 = 0; int _totalPer9 = 0;
        int _totalPer10 = 0; int _totalPer11 = 0; int _sumTotal = 0; int _sumMale = 0; int _sumFemale = 0;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrEmpty(popupDatepicker.Value))
                {
                    DateHG cal = new DateHG();
                    DateTime? startDate;
                    // DateTime? startDate = DateTime.ParseExact(new DateHG().HijriToGreg(invertDate(popupDatepicker.Value.ToString())), "yyyy/MM/dd", new DateHG().arCul.DateTimeFormat, DateTimeStyles.AllowWhiteSpaces);
                    ...
                    dlUsers.DataSource = new VisitorsDataContext().GetDaysTransctions(startDate, startDate.Value.AddDays(30));// Month after  selected date
                    dlUsers.DataBind();
                }
            }
            catch (Exception ex)
