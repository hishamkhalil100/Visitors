 	...
 	alert('Selected ' + dates);
        ...
        regionalOptions: { // Available regional settings, indexed by language/country code
            '': { // Default regional settings - English/US
                ...
                prevText: '&lt;السابق',
                prevStatus: 'اعرض الشهر السابق',
                prevJumpText: '&lt;&lt;',
                prevJumpStatus: 'اعرض العام السابق',
                nextText: 'التالي&gt;',
                nextStatus: 'اعرض الشهر التالي',
                nextJumpText: '&gt;&gt;',
                nextJumpStatus: 'Show the next year',
                currentText: 'الحالي',
                currentStatus: 'Show the current month',
                todayText: 'اليوم',
                todayStatus: 'اعرض اليوم الحالي في الشهر',
                clearText: 'مسح',
                clearStatus: 'امسح كل التواريخ',
                closeText: 'اغلاق',
                closeStatus: 'إغلاق ',
                yearStatus: 'غير السنة',
                monthStatus: 'غير الشهر',
                weekText: 'Wk',
                weekStatus: 'Week of the year',
                dayStatus: 'اختر DD, M d, yyyy',
                defaultStatus: 'اختر تاريخ',
                isRTL: false
            }
        },
 ...
 $(selector).datepick('setDate', [date1, date2, date3]) */
        ...
        _generateContent: function (elem, inst) {
            ...
            picker.find(inst.options.renderer.monthSelector).each(function () {
                width += $("#ContentPlaceHolder1_popupDatepicker").outerWidth();
            });
        ...
        _generateMonthSelection: function (inst, year, month, minDate, maxDate, monthHeader, calendar) {
            ...
            for (var m = calendar.minMonth; m < maxMonth; m++) {
                if ((!minDate || calendar.newDate(year, m,
						...
						compareTo(maxDate) !== +1)) {
                    selector += '<option class="sele" value="' + m + '/' + year + '"' +
