<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthlyReportPrint.aspx.cs" Inherits="Reports.Reports_MonthlyReportPrint" %>
...
<body style="direction: rtl; background: #fff" onload="window.print() " onfocus="window.close()" >
    <div style="margin: 0 auto;">
        ...
        <h4 id="h4date" style="text-align: center;">احصائية شهرية بعدد الزوار من تاريخ
        ...
        <tbody>
            <asp:DataList ID="dlUsers" runat="server" RepeatLayout="Flow" EnableViewState="false" CssClass="table admin-form theme-warning tc-checkbox-1 fs13" RepeatDirection="Horizontal" OnItemDataBound="dlUsers_ItemDataBound">
                <ItemTemplate>
                 ...
                 <footertemplate>
                     <tr  >
                        <td class="text-center footers">المجموع</td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer1"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer2"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer3"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer4"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer5"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer6"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer7"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer8"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer9"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer10"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblTotalPer11"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblSumTotal"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblSumMale"></asp:Label></td>
                        <td class="text-center footers"><asp:Label runat="server" ID="lblSumFemale"></asp:Label></td>
                     </tr>
                    </footertemplate>
